...
PlayScene.update →
  ...
  (if board clear: level-complete SFX → levels 1 and 8: level transition; levels 2-7: pickUpgradeChoiceOffer → modal (pending level clear) or empty pool → level transition; return)
