...
src/
  ...
  domain/                     # Pure helpers (no Phaser, no bitecs world APIs)
    ...
    lives.ts                  # START_LIVES + livesIconCount + livesRemainingAfterCatch
  game/
