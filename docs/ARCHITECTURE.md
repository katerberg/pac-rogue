...
- Power pellets are inert unless an owned upgrade reacts (`powerPelletFreeze`, `powerPelletScatterBurst`, `powerPelletSpeedBurst`, `powerPelletGhostRecall`, `powerPelletWarpTop`, `powerPelletCollectThree` — see [docs/upgrades.md](./upgrades.md)). No arcade fright / eatable ghosts yet.
