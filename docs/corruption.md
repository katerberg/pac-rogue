...
| Id                    | Behavior                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `slimeTrail`          | Lays a lethal 7-tile FIFO trail (`SLIME_TRAIL_MAX_LEN`) behind itself as it moves; the trail is drawn directly (no ECS entities) and checked by `slimeTrailKill`, which mirrors `catchPlayer`'s circle-overlap shape and also skips a `playerInvulnerable` player.                                                                                                                                                                                                                   |
