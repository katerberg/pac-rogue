...
name: pr-review
description: >-
  Senior engineer PR review: gather the diff, apply correctness/security/scope
  lenses, and output a ranked findings list with file+line references. Use when
  reviewing a pull request or when invoked as /pr-review.
---
