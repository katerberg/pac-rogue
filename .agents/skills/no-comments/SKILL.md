...
name: no-comments
description: >-
  Run /no-comments after scoped code changes: spawn Comment Sicko, act on
  accepted findings, and remove unjustified comments without weakening real
  constraints. Required on every implementation plan for this project.
---
