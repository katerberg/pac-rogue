...
| `infiniteLives`        | `1`                               | Debug: getting caught still plays the death SFX and full death sequence (hold / reset / ready / resume), but never spends a life and never triggers Game Over.                                                                                               |
