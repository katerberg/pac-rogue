...
| `maze`          | `maze1` \| `maze2` \| `mazeSmall` | Force that layout for the **first** board of this Start; omit for level-1 `mazeSmall`, then 50/50 random among maze1/maze2 on later levels. Fixtures also use `?maze=` (see [docs/maze-constraints.md](./docs/maze-constraints.md)). |
